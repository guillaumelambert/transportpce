webvowl =
  ...
  /******/([
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      var propertyMap = __webpack_require__(42)();


      var webvowl = {};
      webvowl.graph = __webpack_require__(59);
      webvowl.options = __webpack_require__(66);
      webvowl.version = "1.1.5";

      webvowl.util = {};
      webvowl.util.constants = __webpack_require__(12);
      webvowl.util.languageTools = __webpack_require__(11);
      webvowl.util.elementTools = __webpack_require__(65);
      webvowl.util.prefixTools = __webpack_require__(74);
      webvowl.modules = {};
      webvowl.modules.colorExternalsSwitch = __webpack_require__(75);
      webvowl.modules.compactNotationSwitch = __webpack_require__(76);
      webvowl.modules.datatypeFilter = __webpack_require__(77);
      webvowl.modules.disjointFilter = __webpack_require__(79);
      webvowl.modules.focuser = __webpack_require__(80);
      webvowl.modules.emptyLiteralFilter = __webpack_require__(81);
      webvowl.modules.nodeDegreeFilter = __webpack_require__(82);
      webvowl.modules.nodeScalingSwitch = __webpack_require__(83);
      webvowl.modules.objectPropertyFilter = __webpack_require__(84);
      webvowl.modules.pickAndPin = __webpack_require__(85);
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      (function (d3) {
        ...
        nodes.push(__webpack_require__(37));
        nodes.push(__webpack_require__(40));
        nodes.push(__webpack_require__(41));

        // nodes.push(require("./RectangularNodeCustomized"));
      ...
      (function (d3) {
        ...
        module.exports = (function () {
          ...
          var Base = function (graph) {
            ...
            this.services = function (p) {
              if (!arguments.length) return services;
              services = p || [];
              return this;
            };

            this.wavelengths = function (p) {
              if (!arguments.length) return wavelengths;
              wavelengths = p || [];
              return this;
            };

            this.terminalPoints = function (p) {
              if (!arguments.length) return terminalPoints;
              terminalPoints = p || [];
              return this;
            };
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      module.exports = (function () {
        ...
        languageTools.textInLanguage = function (textObject, preferredLanguage) {
          ...
          /* OLE Customization */
          if (textObject[constants.LANG_IRIBASED]) {
            return textObject[constants.LANG_IRIBASED];
          }

          if (typeof textObject === "object") {
            if (textObject.labels) {
              return JSON.stringify(textObject.labels);
            } else {
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      function CenteringTextElement(container, backgroundColor, text_distance_shifting) {
        ...
        /* OLE Customization */
        if (text_distance_shifting) {
          this.text_distance_shifting_up = text_distance_shifting;
        } else {
          this.text_distance_shifting_up = 0;
        }
      ...
      CenteringTextElement.prototype._repositionTextLine = function (tspan) {
        ...
        /* OLE Customization text_distance_shifting_up*/
        tspan.attr("dy", fontSize + lineDistance + this.text_distance_shifting_up + "px");
      };
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      PlainLink.prototype.draw = function (linkGroup) {
        ...
        var pathLinkType = property.pathLinkType() + ""
        if (pathLinkType.includes('OTN')) {
          console.log('------------------------xxxxx-------------------------------')
          console.log(property.pathLinkType())
          pathElement.classed("otnLinkPath", true)
        }
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      (function (d3) {
        ...
        var RectangularNodeCustomized = __webpack_require__(31);
        var RoundNode = __webpack_require__(8);
        ...
        module.exports = (function () {
          ...
          var o = function (graph) {
            ...
            this.styleClass("clli-node")
              .type("owl:RectangleClass");
            ...
            this.actualRadius = function () {
              console.log("inside - actualRadius");
              return smallestRadius;
            };

            this.distanceToBorder = function (dx, dy) {
              // console.log("inside - distancetoBorder");

              // if(link.domain().type().includes("RectangleClass")){
              //   linkDomainIntersection =  math.calculateIntersection(link.range(), link.domain().getEmbeddedRect()[0], 0);
              // }

              return rectangularElementTools.distanceToBorder(that, dx, dy);

              // return rectangularElementTools.distanceToBorder(that.getEmbeddedRect()[0], dx, dy);
            };
            ...
            this.draw = function (parentElement, additionalCssClasses) {
              ...
              // console.log("Drawing Big rectangle dim ",that.width(), that.height(),that.labelForCurrentLanguage())
              ...
              // shapeElement = drawTools.appendRectangularClass(parentElement, that.width() - 8, that.height() - 8, cssClasses, that.labelForCurrentLanguage(), that.backgroundColor());

              /* OLE Customization */
              textBlock = new CenteringTextElement(parentElement, that.backgroundColor(), (-height / 2 - 10));
            ...
            this.getEmbeddedChildren = function () {
              return embeddedChildren;
            }

            var minWidth = 80;
            var minHeight = 30;
            var internalPadding = 50;
            var outerPadding = 20;

            var embeddedChildren = [];
            var childrenLabel = {};
            var rectangeleNodesMap = {};
            var nodes_details = {};

            this.addEmbeddedChildren = function (newChildren) {

              var childrenLevelMap = buildChildrenTree(newChildren);
              // console.log("ids = ", childrenLevelMap)
              // console.log("labels = ", childrenLabel)
              // console.log(childrenLabel)

              calculateTotalDimension(0, childrenLevelMap);

              updateParentDim(childrenLevelMap[0]);

              var x_pos = -width / 2;//+  (60*0);
              var y_pos = -height / 2;//
              setNodesPosition(childrenLevelMap[0], childrenLevelMap, x_pos, y_pos)
              addingChildrenToMap(childrenLevelMap[0], childrenLevelMap);


              // console.log("-------END-------------")
              // console.log(embeddedChildren, childrenLevelMap);

            }

            function buildChildrenTree(newChildren) {
              var childrenStack = [];
              var level = 1;
              var childrenLevelMap = {};
              childrenLevelMap[0] = [];

              for (var newChildrenIndex in newChildren) {

                var nextChildren = newChildren[newChildrenIndex];
                var childLabel = nextChildren["label"]["undefined"];
                var childId = nextChildren["id"];
                var childType = nextChildren["nodeType"];
                childrenLabel[level] = { label: childLabel, id: childId, type: childType };

                childrenStack.push({ children: nextChildren, level: level });

                childrenLevelMap[level] = [];


                while (childrenStack.length != 0) {

                  var currentChildInStack = childrenStack[childrenStack.length - 1];
                  childrenStack.splice(childrenStack.length - 1, 1)
                  var currentChildren = currentChildInStack.children;
                  var currentLevel = currentChildInStack.level;


                  if (currentChildren.children) {
                    for (var c in currentChildren.children) {
                      var subLevel = parseInt(c) + 1;
                      var childLevel = currentLevel + "." + subLevel
                      childrenStack.push({ children: currentChildren.children[c], level: childLevel })

                      childLabel = currentChildren.children[c]["label"]["undefined"];
                      childId = currentChildren.children[c]["id"];
                      childType = currentChildren.children[c]["nodeType"];
                      childrenLabel[childLevel] = { label: childLabel, id: childId, type: childType };
                      if (!childrenLevelMap[currentLevel]) {
                        childrenLevelMap[currentLevel] = [];
                      }
                      childrenLevelMap[currentLevel].push(childLevel)
                    }
                  }
                }

                childrenLevelMap[0].push(level);
                level++;
              }
              return childrenLevelMap;
            }

            function updateParentDim(parentNode) {
              var borders = calculateMargin(parentNode)

              width = borders["horiztonal"]["maxWidth"] + borders["horiztonal"]["margin"];
              height = borders["vertical"]["maxHeight"] + borders["vertical"]["margin"];

              smallestRadius = height / 2;
              nodes_details[0]["width"] = width
              nodes_details[0]["height"] = height;
            }

            function calculateAccumualtiveDim(nodeDim, xPos, yPos) {

              var prevXpos = xPos - 1;
              var prevYpos = yPos - 1;
              var accumulativePrevWidth = 0;
              if (nodeDim[prevXpos] != undefined) {
                if (nodeDim[prevXpos][yPos] != undefined) {
                  accumulativePrevWidth = nodeDim[prevXpos][yPos].width;
                } else if (nodeDim[prevXpos][prevYpos] != undefined) {
                  accumulativePrevWidth = nodeDim[prevXpos][prevYpos].width;
                }
              }

              var accumulativePrevHeight = 0;
              if (nodeDim[xPos][prevYpos] != undefined) {
                accumulativePrevHeight = nodeDim[xPos][prevYpos].height;
              } else if (nodeDim[prevXpos] != undefined && nodeDim[prevXpos][prevYpos] != undefined) {
                accumulativePrevHeight = nodeDim[prevXpos][prevYpos].height;
              }

              return { width: accumulativePrevWidth, height: accumulativePrevHeight };
            }

            function setNodesPosition(childsNodes, childrenLevelMap, startXPos, startYPos) {

              var parentNodeDim = [];
              for (var iId in childsNodes) {
                var parentId = childsNodes[iId]

                var childIds = childrenLevelMap[parentId];
                var parentNode = nodes_details[parentId]

                var xPos = parentNode["xpos"];
                var yPos = parentNode["ypos"];

                if (parentNodeDim[xPos] == undefined) {
                  parentNodeDim[xPos] = [];
                }

                var accumulativeDim = calculateAccumualtiveDim(parentNodeDim, xPos, yPos);
                var accumulativePrevWidth = accumulativeDim.width;
                var accumulativePrevHeight = accumulativeDim.height;

                var recNode = {};
                if (childIds && childIds.length > 0) {
                  recNode = new RectangularNodeCustomized(graph, parentNode["width"], parentNode["height"], true);
                } else {
                  // centerlized text for last leafs only
                  recNode = new RectangularNodeCustomized(graph, parentNode["width"], parentNode["height"]);
                }


                var childLabel = childrenLabel[parentId].label;
                var childId = childrenLabel[parentId].id;
                var childType = childrenLabel[parentId].type;

                recNode.parentNodeId = that.id();

                recNode.label(childLabel);
                recNode.id(childId);
                assignCssClass(childType, childId, recNode);
                // recNode.styleClass("transparent-node")

                recNode.position_x = (startXPos + parentNode["width"] / 2) + (internalPadding + accumulativePrevWidth);
                recNode.position_y = (startYPos + parentNode["height"] / 2) + (internalPadding + accumulativePrevHeight);


                if (parentNodeDim[xPos][yPos] == undefined) {
                  parentNodeDim[xPos][yPos] = { width: parentNode["width"], height: parentNode["height"] };
                }
                parentNodeDim[xPos][yPos] = {
                  width: parentNodeDim[xPos][yPos].width + accumulativePrevWidth + internalPadding,
                  height: parentNodeDim[xPos][yPos].height + accumulativePrevHeight + internalPadding
                };


                var parentX = recNode.position_x - parentNode["width"] / 2;
                var parentY = recNode.position_y - parentNode["height"] / 2;

                rectangeleNodesMap[parentId] = recNode;
                setNodesPosition(childIds, childrenLevelMap, parentX, parentY);

              }
            }

            function assignCssClass(type, id, rectangle) {

              if (type) {
                if (type.toLowerCase() === "roadm") {
                  console.log("roadm")
                  rectangle.styleClass("roadm-node");
                } else if (type.toLowerCase() === "degree") {
                  console.log("deg")
                  rectangle.styleClass("deg-node");
                } else if (type.toLowerCase() === "srg") {
                  console.log("srg")
                  rectangle.styleClass("srg-node");
                } else if (type.toLowerCase() === "xponder" && id.includes("#parent")) {// #parent defined in back-end to identify xpdr child from parent
                  rectangle.styleClass("xpdr-node");
                  console.log("xpdr-nod")
                } else if (type.toLowerCase() === "xponder") {
                  rectangle.styleClass("xpdr-child-node");
                  console.log("xpdr-child")
                } else if (type.toLowerCase() === "muxpdr" || type.toLowerCase() === "switch") {
                  console.log("muxpdr-node")
                  rectangle.styleClass("muxpdr-node");
                }
              } else {
                // TODO default type
              }
            ...
            function addingChildrenToMap(childsNodes, childrenLevelMap) {
              var children = [];
              for (var iId in childsNodes) {
                var parentId = childsNodes[iId]
                var childIds = childrenLevelMap[parentId];
                var node = rectangeleNodesMap[parentId];

                children.push(node);
                for (var childIndex in childIds) {
                  var childLevelId = childIds[childIndex];
                  var node = rectangeleNodesMap[childLevelId];
                  children.push(node);
                }
              }
              embeddedChildren.push(children);
            }

            function calculateTotalDimension(parentId, childrenLevelMap) {

              nodes_details[parentId] = {};
              nodes_details[parentId]["width"] = minWidth;
              if (childrenLevelMap[parentId] && childrenLevelMap[parentId].length > 0) {
                nodes_details[parentId]["width"] = 0;
                var childIds = childrenLevelMap[parentId];

                for (var id in childIds) {
                  var indx = childIds[id];
                  nodes_details[indx] = {};
                  nodes_details[indx]["width"] = calculateTotalDimension(indx, childrenLevelMap);
                  nodes_details[parentId]["width"] += nodes_details[indx]["width"];
                }
              }

              adjustDimensionWithXY(parentId, nodes_details, childrenLevelMap);
              if (childrenLevelMap[parentId] && childrenLevelMap[parentId].length > 0) {

                // console.log("BeforeMargin ",childrenLabel[parentId], nodes_details[parentId]["width"], nodes_details[parentId]["height"]);

                var borders = calculateMargin(childrenLevelMap[parentId])
                // nodes_details[parentId]["width"] = borders["horiztonal"]["maxWidth"];
                nodes_details[parentId]["width"] += borders["horiztonal"]["margin"];

                nodes_details[parentId]["height"] = borders["vertical"]["maxHeight"];
                nodes_details[parentId]["height"] += borders["vertical"]["margin"];

                // console.log("AfterMargin ",childrenLabel[parentId], nodes_details[parentId]["width"], nodes_details[parentId]["height"]);
              }
              return nodes_details[parentId]
            }

            function calculateMargin(childs) {
              var totalWidthPerY = [];
              var totaHeightPerX = [];
              var maxWidthPerY = 0;
              var maxHeightPerX = minHeight;

              // console.log("calculating Margin ");
              for (var id in childs) {
                var nodeId = childs[id];
                var currentNode = nodes_details[nodeId];
                var xpos = currentNode["xpos"];
                var ypos = currentNode["ypos"];

                if (totalWidthPerY[ypos] == undefined) {
                  totalWidthPerY[ypos] = 0;
                }
                totalWidthPerY[ypos] += currentNode["width"];
                if (totalWidthPerY[ypos] > maxWidthPerY) {
                  maxWidthPerY = totalWidthPerY[ypos];
                }


                if (totaHeightPerX[xpos] == undefined) {
                  totaHeightPerX[xpos] = 0;
                }
                totaHeightPerX[xpos] += currentNode["height"];

                if (totaHeightPerX[xpos] > maxHeightPerX) {
                  maxHeightPerX = totaHeightPerX[xpos];
                }

              }
              // console.log("calculating Margin ",parentHeight, parentWidth);

              var borders = {};
              var horiztonal = {};
              var vertical = {};
              horiztonal["maxWidth"] = maxWidthPerY;
              horiztonal["margin"] = (totaHeightPerX.length + 1) * internalPadding;

              vertical["maxHeight"] = maxHeightPerX;
              vertical["margin"] = (totalWidthPerY.length + 1) * internalPadding;

              borders["horiztonal"] = horiztonal;
              borders["vertical"] = vertical;

              // console.log("Margins value ", totaHeightPerX.length, vertical["margin"], totalWidthPerY.length,horiztonal["margin"])
              // console.log("Margins length h=",vertical["maxHeight"], horiztonal["maxWidth"])
            ...
            var minItemPerSquare = 5;

            function adjustDimensionWithXY(parentId, nodes_details, childrenLevelMap) {

              var calculatedWidth = nodes_details[parentId]["width"] / 2;
              calculatedWidth = Math.round(calculatedWidth / minWidth) * (minWidth);

              if (calculatedWidth > minWidth * minItemPerSquare) {
                calculatedWidth = minWidth * minItemPerSquare;
              }

              // console.log("############### Calcuatling X, Y  = ",childrenLabel[parentId], "before", nodes_details[parentId]["width"]," after" , calculatedWidth);

              nodes_details[parentId]["width"] = calculatedWidth
              nodes_details[parentId]["height"] = minHeight;

              let x_pos = 0, y_pos = 0;
              let totalWidth = calculatedWidth;
              var childNodesId = childrenLevelMap[parentId];
              var yPosAssigned = false;
              for (var childIndex in childNodesId) {
                var childId = childNodesId[childIndex];
                var childNode = nodes_details[childId];
                if (childNode) {
                  if (totalWidth >= childNode["width"]) {
                    childNode["xpos"] = x_pos;
                    childNode["ypos"] = y_pos;
                    x_pos++;
                    yPosAssigned = true;
                  } else {
                  ...
                  console.log("[Warning] NO Position set for ", childId);
                }
                // console.log(childrenLabel[childId], childNode["width"], childNode["height"], childNode["xpos"] , childNode["ypos"] );
              }
            ...
            this.updateTextElement = function () {
              console.log("inside - updateTextElement");
            ...
            this.redrawLabelText = function () {
              console.log("inside - redraw-text");
              textBlock.remove();
            ...
            this.addTextLabelElement = function () {
              console.log("inside - addTextLabel");
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      (function (d3) {
        ...
        module.exports = (function () {
          ...
          var o = function (graph, w, h, textMoveUp) {
            BaseNode.apply(this, arguments);
            ...
            // this.styleClass("transparent-node")
            this.type("owl:embeddedRectangleClass");


            // Properties
            this.height = function (p) {
              // console.log("inside[2] - height");
              if (!arguments.length) return height;
              height = p;
              return this;
            };
            ...
            // for compatibility reasons // TODO resolve
            this.actualRadius = function () {
              // console.log("inside[2] - actualRadius");
              return smallestRadius;
            };

            this.distanceToBorder = function (dx, dy) {
              // console.log("inside[2] - distancetoBorder");
              return rectangularElementTools.distanceToBorder(that, dx, dy);
            };

            this.setHoverHighlighting = function (enable) {
              // console.log("inside[2] - setHoverHighlighting");
              that.nodeElement().selectAll("rect").classed("hovered", enable);
            ...
            this.textWidth = function () {
              // console.log("inside[2] - textWidth");
              return labelWidth;
            };
            this.width = function () {
              /** OLE Customization **/
            ...
            this.getMyWidth = function () {
              ...
              var indicatorText = that.indicationString();
              var indicatorWidth = measureTextWidth(indicatorText, "subtext") + 20;
              // console.log("inside[before] - getMyWidth",myWidth, that.labelForCurrentLanguage(), indicatorWidth);
              if (indicatorWidth > myWidth)
                myWidth = indicatorWidth;

              // console.log("inside[after] - getMyWidth",myWidth, that.labelForCurrentLanguage(),width);
              return myWidth;
            };

            this.textWidth = function () {
              // console.log("inside[2] - textWidth",that.width());
              return that.width();
            };

            function measureTextWidth(text, textStyle) {
              // console.log("inside[2] - measureTextWidth");
              // Set a default value
              if (!textStyle) {
                textStyle = "text";
              }
              ...
              // console.log("measureTextWidth = ",w)
              return w;
            }

            this.toggleFocus = function () {
              console.log("inside[2] - toggleFocus");
              that.focused(!that.focused());
              that.nodeElement().select("rect").classed("focused", that.focused());
              graph.resetSearchHighlight();
              graph.options().searchMenu().clearText();
            ...
            this.draw = function (parentElement, additionalCssClasses) {
              ...
              if (graph.options().dynamicLabelWidth() === true) {
                ...
                labelWidth = defaultWidth;
                // console.log("graph options out")
              }

              // console.log(graph.options().dynamicLabelWidth() , width, that.getMyWidth(), graph.options().maxLabelWidth());
              labelWidth = width;
              // console.log("label = ",that.labelForCurrentLanguage(), width, labelWidth)
              shapeElement = drawTools.appendRectangularClass(parentElement, that.width(), that.height(), cssClasses, that.labelForCurrentLanguage(), that.backgroundColor());


              /* OLE Customization allow to move position text */
              if (textMoveUp) {
                textBlock = new CenteringTextElement(parentElement, that.backgroundColor(), (-height / 2 - 8));
              } else {
            ...
            this.animateDynamicLabelWidth = function (dynamic) {
              console.log("inside[2] - animateDynamicLabelWidth");
              that.removeHalo();
              var height = that.height();
              if (dynamic === true) {
                labelWidth = Math.min(that.getMyWidth(), graph.options().maxLabelWidth());
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      var OwlThing = __webpack_require__(34);
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      var DatatypeNode = __webpack_require__(38);
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      var RectangularNode = __webpack_require__(39);
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      (function (d3) {
        ...
        properties.push(__webpack_require__(57));
        properties.push(__webpack_require__(58));
      ...
      (function (d3) {
        ...
        module.exports = (function () {
          ...
          var Base = function (graph) {
            ...
            this.pathLinkType = function (p) {
              if (!arguments.length) return pathLinkType;
              pathLinkType = p;
              return this;
            };
            ...
            this.draw = function (labelGroup) {
              function attachLabel(property) {
                /* OLE Customization */
                if (property.labelForCurrentLanguage() && property.labelForCurrentLanguage().trim()) {
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      (function (d3) {
        ...
        var math = __webpack_require__(45)();
        var linkCreator = __webpack_require__(62)();
        var elementTools = __webpack_require__(65)();
        // add some maps for nodes and properties -- used for object generation
        var nodePrototypeMap = __webpack_require__(5)();
        var propertyPrototypeMap = __webpack_require__(42)();
        ...
        module.exports = function (graphContainerSelector) {
          var graph = {},
            ...
            curveFunction = d3.svg.line()
              ...
              .interpolate("cardinal"),
            options = __webpack_require__(66)(),
            parser = __webpack_require__(67)(graph),
            language = "default",
            paused = false,
          ...
          var classDragger = __webpack_require__(70)(graph);
          var rangeDragger = __webpack_require__(71)(graph);
          var domainDragger = __webpack_require__(72)(graph);
          var shadowClone = __webpack_require__(73)(graph);
            ...
            dragBehaviour = d3.behavior.drag()
              ...
              .on("drag", function (d) {
                ...
                if (d.type && d.type() === "Class_dragger") {
                  ...
                  var botRight = getWorldPosFromScreen(graph.options().width(), graph.options().height(), graphTranslation, zoomFactor);
                  if (!(d3.event.x >= botRight.x || d3.event.x <= topLeft.x)) {
                    d.px = d3.event.x;
                  }
                  if (!(d3.event.y >= botRight.y || d3.event.y <= topLeft.y)) {
                    d.py = d3.event.y;
                  }
          ...
          function validateCollision() {
            ...
            for (var i = 0; i < nodes.length; i++) {
              if ("type" in nodes[i] && nodes[i].type() == "owl:RectangleClass") {
            ...
            for (var i = 0; i < nodeList.length; i++) {
              for (var j = i + 1; j < nodeList.length; j++) {
                if (isConflict(nodeList[i], nodeList[j])) {

                  var movesA = getConflictDirection(nodeList[i], nodeList[j]);
                  var movesB = getConflictDirection(nodeList[j], nodeList[i]);

                  moveNode(nodeList[i], movesA)
                  moveNode(nodeList[j], movesB)
                  i = 0; // TODO Need to be enhanced to avoid infinite checks
                  break;
                }
              }
            }
          ...
          /**********   OLE Customization ********/
          function getConflictDirection(nodeA, nodeB) {
            var move = [];
            if (nodeA.x > nodeB.x) {  // B A
              if (nodeA.x - nodeA.width() / 2 <= nodeB.x + nodeB.width() / 2) {
                //node A move right
                move.push("right")
              }
            } else if (nodeB.x > nodeA.x) {  // A B
              if (nodeB.x - nodeB.width() / 2 <= nodeA.x + nodeA.width() / 2) {
                //node A move left
                move.push("left")
              }
            }
            if (nodeA.y > nodeB.y) {
              if (nodeA.y - nodeA.height() / 2 <= nodeB.y + nodeB.height() / 2) {
                //node A move down
                move.push("down")
              }
            } else if (nodeB.y > nodeA.y) {
              if (nodeB.y - nodeB.height() / 2 <= nodeA.y + nodeA.height() / 2) {
                //node A move up
                move.push("up")
              }
            }
          ...
          /**********   OLE Customization ********/
          function isConflict(nodeA, nodeB) {

            var nodeA_TopLeft = { x: nodeA.x - nodeA.width() / 2, y: nodeA.y - nodeA.height() / 2 };
            var nodeA_BottomRight = { x: nodeA.x + nodeA.width() / 2, y: nodeA.y + nodeA.height() / 2 };
            var nodeB_TopLeft = { x: nodeB.x - nodeB.width() / 2, y: nodeB.y - nodeB.height() / 2 };
            var nodeB_BottomRight = { x: nodeB.x + nodeB.width() / 2, y: nodeB.y + nodeB.height() / 2 };

            if (nodeA_TopLeft.x > nodeB_BottomRight.x || nodeB_TopLeft.x > nodeA_BottomRight.x) {
              return false;
            }

            // If one rectangle is above other
            if (nodeA_TopLeft.y > nodeB_BottomRight.y || nodeB_TopLeft.y > nodeA_BottomRight.y) {
              return false;
            }
          ...
          function recalculatePositions() {
            ...
            /* OLE Customization   */
            graphContainer.select("svg").attr("width", $("#graph").width());
            ...
            if (!editMode) {
              ...
              validateCollision()
              zoom.scaleExtent([options.minMagnification(), options.maxMagnification()]);
              zoom.translate(graphTranslation);
              zoom.scale(zoomFactor);
              ...
              nodeElements.attr("transform", function (node) {
                ...
                if (node.type().includes("embeddedRectangleClass")) {
                  return "translate(" + node.x + "," + node.y + ")";
                } else if (node.type() == "owl:RectangleClass") {
                  rect_pos[node.id()] = [node.x, node.y];
              ...
              nodeElements.attr("transform", function (node) {
                if (node.type().includes("embeddedRectangleClass")) {
                  ...
                  node.x = rect_pos[node.parentNodeId][0] + node.position_x;
                  node.y = rect_pos[node.parentNodeId][1] + node.position_y;
              ...
              labelGroupElements.attr("transform", function (label) {
                ...
                var link = label.link();
                /* OLE Customization */
                var isSameParent = force.nodes()[nodeMap[link.domain().id()]].parentNodeId == force.nodes()[nodeMap[link.range().id()]].parentNodeId;

                if (isSameParent && !link.loops()) {
          ...
          var extraLinks = [];
          graph.addExtraLink = function (sourceId, targetId, label,serviceName) {
            var source = "", target = "";
            unfilteredData.nodes.forEach(function (node) {
            ...
            var defaultPropertyName = "rdfs:subClassOf";//d3.select("#defaultProperty").node().title;
            var propPrototype = PropertyPrototypeMap.get(defaultPropertyName.toLowerCase());
            var aProp = new propPrototype(graph);
            aProp.id(source.id() + "to" + target.id() + serviceName);
            aProp.domain(source);
            aProp.range(target);
            aProp.label(label);
            console.log('added prop' +aProp);


            createNewObjectProperty(source, target, undefined, aProp, label);

          }

          graph.removeExtraLink = function (sourceId, targetId ,serviceName) {
            for (var linkIndex in extraLinks) {
              if (extraLinks[linkIndex].domain().id() == sourceId && extraLinks[linkIndex].range().id() == targetId
              && extraLinks[linkIndex].id().toString().includes(serviceName)) {
                graph.removeNodesViaResponse([], [extraLinks[linkIndex]]);
              }
            }
          }

          graph.removeAllExtraLinks = function () {
            graph.removeNodesViaResponse([], extraLinks);
            extraLinks = [];
          }
          ...
          function redrawContent() {
            ...
            /* OLE Customization  */
            // Re-order nodeContainer to be at the two instead of the bottom
            ...
            linkGroups.each(function (link) {
              console.log('this is from links');
              console.log(link.domain().id().toString());
              console.log(link.property().id());
              console.log(link.property());
              console.log(link);
              if (link.property().id().toString().includes('OTU4') || link.property().id().toString().includes('ODU4')) {
                console.log('hello from otu and odu ');
                link.property().focused(true);
                link.styleClass("testLink");
                console.log(link.domain().cssClassOfNode());
              }
          ...
          /* OLE Customization */
          function createNewObjectProperty(domain, range, draggerEndposition, inverse, label) {
            ...
            aProp.label(label);
            if (inverse) {
              aProp.inverse(inverse)
            }
            extraLinks.push(aProp);
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      var ArrowLink = __webpack_require__(63);
      var BoxArrowLink = __webpack_require__(22);
      var PlainLink = __webpack_require__(23);
      var OwlDisjointWith = __webpack_require__(48);
      var SetOperatorProperty = __webpack_require__(58);
      ...
      module.exports = (function () {
        ...
        function groupPropertiesToLinks(properties) {
          var links = [],
            property,
            addedProperties = __webpack_require__(64)();
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      var BaseNode = __webpack_require__(9);
      var DatatypeNode = __webpack_require__(38);
      var Thing = __webpack_require__(34);
      var ObjectProperty = __webpack_require__(52);
      var DatatypeProperty = __webpack_require__(46);
      var RdfsSubClassOf = __webpack_require__(57);
      var Label = __webpack_require__(24);
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      (function (d3) {
        ...
        var equivalentPropertyMerger = __webpack_require__(69)();
        var nodePrototypeMap = __webpack_require__(5)();
        var propertyPrototypeMap = __webpack_require__(42)();
            ...
            if (baseObjects) {
              baseObjects.forEach(function (element) {
                ...
                if (Prototype) {
                  ...
                  /* OLE Customization */
                  if (node.type() == "owl:RectangleClass") {
                    node.addEmbeddedChildren(element.children);
                    element.pinned = true;
                  }
                  if (element.pos) {
                  ...
                  // Create node wavelengths for all services
                  if (element.wavelengths) {
                    element.wavelengths.forEach(function (wavelength) {
                      var wavelengthNode = new Prototype(graph);
                      wavelengthNode.label(wavelength);
                      node.wavelengths().push(wavelengthNode);
                    });
                  }

                  // Create node objects for all terminalPoints
                  if (element.terminalPoints) {
                    element.terminalPoints.forEach(function (terminalPoint) {
                      var terminalPointNode = new Prototype(graph);
                      terminalPointNode.label(terminalPoint);
                      node.terminalPoints().push(terminalPointNode);
                    });
                  }

                  // Create node objects for all services
                  if (element.services) {
                    element.services.forEach(function (service) {
                      var servicelNode = new Prototype(graph);
                      servicelNode.label(service.labels);

                      node.services().push(servicelNode);
                    });
                  }
                  ...
                  /* OLE Customization */
                  if (node.type() == "owl:RectangleClass") {
                    var groups = node.getEmbeddedChildren();
                    for (var groupIndex in groups) {
                      for (var childrenIndex = 0; childrenIndex < groups[groupIndex].length; childrenIndex++) {
                        combinations.push(groups[groupIndex][childrenIndex]);
                      }
                    }
                  }
                } else {
          ...
          function createPropertyStructure(rawProperties, classMap, propertyMap) {
            ...
            rawProperties.forEach(function (property) {
              ...
              var domain,
                ...
                rangeObject,
                inverse;
              if (property.id().toString().includes('OTU4') || property.id().toString().includes('ODU4')) {
                property.focused(true);

                property.styleClass(".property.hovered");
                property.styleClass("test");
              }
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      (function (d3) {
        var OwlThing = __webpack_require__(34);
        var RdfsLiteral = __webpack_require__(40);
        var elementTools = __webpack_require__(65)();
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      var elementTools = __webpack_require__(65)();
      var filterTools = __webpack_require__(78)();
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      module.exports = (function () {
        ...
        tools.filterNodesAndTidy = function (nodes, properties, shouldKeepNode) {
          var removedNodes = __webpack_require__(64)(),
            cleanedNodes = [],
            cleanedProperties = [];
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      var DataView = __webpack_require__(206),
        ...
        baseGetTag = __webpack_require__(93),
        toSource = __webpack_require__(128);
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      var isIndex = __webpack_require__(101);
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      module.exports = function () {
        ...
        var filter = {},
          ...
          filteredNodes,
          filteredProperties,
          filterTools = __webpack_require__(78)();
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      (function (d3) {
        var SetOperatorNode = __webpack_require__(20);
        var OwlThing = __webpack_require__(34);
        var OwlNothing = __webpack_require__(33);
        var elementTools = __webpack_require__(65)();
        ...
        module.exports = function () {
          ...
          function storeTotalCounts(classesAndDatatypes, properties) {
            ...
            var seenProperties = __webpack_require__(64)(), i, l, property;
            for (i = 0, l = properties.length; i < l; i++) {
              property = properties[i];
        ...
        function findRelevantConnectedProperties(node, allProperties, visitedNodes) {
          ...
          for (i = 0, l = allProperties.length; i < l; i++) {
	         ...
	         */
              ...
              if (elementTools.isRdfsSubClassOf(property)) {
                var domain = property.domain();
                visitedNodes = visitedNodes || __webpack_require__(64)();
