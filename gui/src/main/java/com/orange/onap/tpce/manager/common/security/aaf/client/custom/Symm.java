...
public class Symm {
    ...
    public interface Encryption {
        CipherOutputStream outputStream(OutputStream os, boolean encrypt);

        CipherInputStream inputStream(InputStream is, boolean encrypt);
    }

    public interface SyncExec<T> {
        T exec(AES aes) throws Exception;

        Void exec(Encryption enc) throws Exception;
    }
    ...
    private interface Convert {
        int convert(int read) throws IOException;
    }
    ...
    public void enpass(final String password, final OutputStream os) throws IOException {
        ...
        try {
            exec(new SyncExec<Void>() {
                ...
                @Override
                public Void exec(AES aes) throws Exception {
    ...
    public long depass(final String password, final OutputStream os) throws IOException {
        ...
        try {
            Void exec = exec(new SyncExec<Void>() {
                @Override
