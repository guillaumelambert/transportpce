...
public class DeviceManagerOscaImpl implements AutoCloseable  {

    private static final Logger LOG = LoggerFactory.getLogger(DeviceManagerOscaImpl.class);
    private static final String APPLICATION_NAME = "DeviceManagerOSca";
    @SuppressWarnings("unused")
    private static final String CONFIGURATIONFILE = "etc/devicemanager-osca.properties";
    ...
    private FactoryRegistration<OscaNetworkElementFactory> resOSca;

    // Blueprint begin
    public DeviceManagerOscaImpl() {
    ...
    public void init() throws Exception {
        ...
        resOSca = netconfNetworkElementService.registerNetworkElementFactory(new OscaNetworkElementFactory());
