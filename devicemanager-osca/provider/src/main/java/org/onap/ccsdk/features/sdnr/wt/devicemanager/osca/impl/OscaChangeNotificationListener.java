 ...
 */
public class OscaChangeNotificationListener  implements IetfNetconfNotificationsListener {

    private static final Logger log = LoggerFactory.getLogger(OscaChangeNotificationListener.class);

    private final NetconfAccessor netconfAccessor;
    private final DataProvider databaseService;

    public OscaChangeNotificationListener(NetconfAccessor netconfAccessor, DataProvider databaseService) {
