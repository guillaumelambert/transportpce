...
//import org.opendaylight.yang.gen.v1.http.org.openroadm.device.rev191129.change.notification.DateAndTime;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
public class OscaDeviceChangeNotificationListener implements OrgOpenroadmDeviceListener {
	...
	private Integer counter = 1;
	   public OscaDeviceChangeNotificationListener(NetconfAccessor netconfAccessor, DataProvider databaseService) {
	...
	public void onChangeNotification(ChangeNotification notification) {
        ...
        @NonNull List<org.opendaylight.yang.gen.v1.http.org.openroadm.device.rev191129.change.notification.Edit> editList = notification.nonnullEdit();
	...
	public void onCreateTechInfoNotification(CreateTechInfoNotification notification) {
        ...
        EventlogBuilder eventlogBuilder = new EventlogBuilder();
        eventlogBuilder.setId(notification.getShelfId())
        .setAttributeName(notification.getShelfId())
        .setObjectId(notification.getShelfId())
        .setNodeId(this.netconfAccessor.getNodeId().getValue())
        .setCounter(counter)
        .setNewValue(notification.getStatus().getName())
