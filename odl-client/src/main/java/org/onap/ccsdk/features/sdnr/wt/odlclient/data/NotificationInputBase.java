...
public class NotificationInputBase {
    ...
    public NotificationInputBase(JsonNode notification, String nodeId, ReducedSchemaInfo type, DateAndTime eventTime) {
