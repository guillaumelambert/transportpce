...
public class RemoteListenerRegistration<L extends DataTreeChangeListener<Node>, T extends Node>
    ...
    public interface CloseCallback<L extends DataTreeChangeListener<Node>, T extends Node>{
        void onClose(RemoteListenerRegistration<L, T > reg);
    }
}
